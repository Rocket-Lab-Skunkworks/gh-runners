...
# xip -x ~/Desktop/Xcode_16.0.0.xip

# Install Xcode command line tools
# sudo /usr/sbin/softwareupdate -i "Command Line Tools for Xcode-16.0.0"
...
# install latest version of node 20 and this becomes the default
nvm install 20

# copy zshrc to bashrc
cp ~/.zshrc ~/.bashrc

# Install GitHub self host runner agent
mkdir ~/actions-runner && cd ~/actions-runner
curl -o actions-runner-osx-x64-2.324.0.tar.gz -L https://github.com/actions/runner/releases/download/v2.311.0/actions-runner-osx-x64-2.311.0.tar.gz
